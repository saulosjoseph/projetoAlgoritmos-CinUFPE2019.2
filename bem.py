class bem:
    ...
    def __str__(self):
        ...
        ' Descrição: ' + self.get_DS_BEM_CANDIDATO())
        return texto
    ...
    def coincide(self, bem):
        if(self.get_CD_TIPO_BEM_CANDIDATO == bem.get_CD_TIPO_BEM_CANDIDATO() and self.get_DS_BEM_CANDIDATO() == bem.get_DS_BEM_CANDIDATO()):
            return True
        return False